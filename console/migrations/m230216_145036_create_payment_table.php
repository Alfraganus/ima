...
class m230216_145036_create_payment_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('{{%payments}}', [
            ...
            'invoice_created_at' => $this->string(32),
            'invoice_updated_at' => $this->string(32),
            'invoice_expire_date' => $this->string(32),
            ...
            'billing_created_at' => $this->string(32),
            'billing_updated_at' => $this->string(32),
