<div class="container">
    ...
    <div class="body_text">
        ...
        <div class="table" style="text-align: left">
            <div class="row">
                ...
                <div class="cell-20"><span>29.04.2022</span></div>
                <div class="cell-25"><span>Talabnoma raqami:</span></div>
                <div class="cell-25">SAP 2022 0091</div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="cell">  <span>Samarqand davlat arxitektura qurilish instituti, UZ</span></div>
            </div>
            <div class="row">
    ...
    <div class="footer">
        <p style="font-size: 16px">Sanoat namunasiga berilgan patent O'zbekiston Respublikasi hududida 29.04.2022 yildan boshlab patentni
            kuchda saqlab turish uchun patent boji o'z vaqtida to'langandagina 10 yil mobaynida amal qiladi.
            <br>
            O'zbekiston Respublikasi Sanoat namunalari davlat reyestrida 30.12.2022 yilda ro'yxatdan o'tkazildi.
        </p>
    </div>
    <div class="qrCode">
