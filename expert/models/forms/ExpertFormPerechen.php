...
/**
 * This is the model class for table "expert_form_perechen".
 *
 * @property int $id
 ...
 */
class ExpertFormPerechen extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['expert_id', 'user_id', 'application_id', 'user_application_id', 'module_id', 'language'], 'integer'],
