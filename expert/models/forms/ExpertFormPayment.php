        ...
        switch ($tab_id) {
            case 1:
                $paymentTypes = [
                    ...
                    3 => 'Доплата за экспертизу заявки',
                    4 => 'За восстановление',
                    5 => 'За выделение заявки',
                    6 => 'За продление срока предосталение ответа',
                ];
                break;
            case 2:
                $paymentTypes = [
                    1 => 'За проведение экспертизы по существу',
                    2 => 'За внесение изменений',
                    3 => 'За восстановление делопроизводства',
                    4 => 'За выделение заявки ',
                    5 => 'За продление срока предоставления документов',
                ];
                break;
            case 3:
                $paymentTypes = [
