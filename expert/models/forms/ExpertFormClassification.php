...
/**
 * This is the model class for table "expert_form_classification".
 *
 * @property int $id
 ...
 */
class ExpertFormClassification extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'expert_form_classification';
    }
    ...
    {
        return [
            [['expert_id', 'user_id', 'application_id', 'module_id', 'user_application_id'], 'integer'],
            [['class', 'sub_class'], 'string', 'max' => 200],
